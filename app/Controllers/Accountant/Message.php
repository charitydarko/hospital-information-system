...
class Message extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['content'] = view('accountant/message/index', $data);
    ...
    public function add()
    {
        ...
        $data['content'] = view('accountant/message/add', $data);
		return view('accountant/layout/main_wrapper',$data);
    }
    ...
    public function sent() {
        ...
        $data['user'] = $this->user_model;
        $data['content'] = view('accountant/message/sent', $data);
		return view('accountant/layout/main_wrapper',$data);
    }
    ...
    public function inbox_information($id = null) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'View';
        $data['content']  = view('accountant/message/view',$data);
        return view('accountant/layout/main_wrapper',$data);
    }
