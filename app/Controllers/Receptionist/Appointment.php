...
class Appointment extends BaseController
{
    ...
    public function index() {
        ...
        $data['title'] = 'List';
        $data['content']  = view('receptionist/appointment/index',$data);
    ...
    public function add() {
        $data['heading'] = $this->heading;
        $data['title'] = 'Add';
        $data['content']  = view('receptionist/appointment/add',$data);
        return view('receptionist/layout/main_wrapper',$data);
    }
    ...
    public function view($id) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'Profile';
        $data['content']  = view('receptionist/appointment/view',$data);
        return view('receptionist/layout/main_wrapper',$data);
    }
    ...
    public function edit($id) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'Edit';
        $data['content']  = view('receptionist/appointment/edit',$data);
        return view('receptionist/layout/main_wrapper',$data);
    }
    ...
    public function update($id) {
        ...
        if ($this->appointment_model->save($appointment)) {
          return redirect()->to("/receptionist/appointment/view/$id")->with('info', 'Appointment updated successfully');
        } else {
          return redirect()->back()->with('error', $appointment_model->errors)->with('error', 'Invalid data');
        }
    }
    ...
    public function delete($id) {
        ...
        return redirect()->to( base_url('receptionist/appointment'))->with('info', 'Appointment deleted successfully');
    }
