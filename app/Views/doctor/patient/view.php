        ...
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    ...
                    <a class="btn btn-primary" href="<?php echo base_url("doctor/patient") ?>"> <i class="fa fa-list"></i> Patient List</a>  
                                                ...
                                                <?php if (!empty($appointments)) { ?>
                                                    ...
                                                    <?php foreach ($appointments as $appointment) { ?>
                                                        <tr class="<?= ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                                            ...
                                                            <td class="center">
                                                                <a href="<?=site_url("/doctor/appointment/view/".$appointment->appointment_id)?>" class="btn btn-xs btn-success" title="View Patient Appointment"><i class="fa fa-eye"></i></a>

                                                                <a href="<?=site_url("/doctor/vitals/add/".$appointment->appointment_id)?>" class="btn btn-xs btn-warning" title="Add Patient Vitals"><i class="fa fa-heart-pulse"></i></a> 

                                                                <a href="<?=site_url("/doctor/appointment/edit/".$appointment->appointment_id)?>" class="btn btn-xs btn-primary" title="Edit Patient Appointment"><i class="fa fa-edit"></i></a> 
                                                            </td>
                                                        </tr>
                                                        <?php $sl++; ?>
                                                    <?php } ?> 
