...
class User extends BaseController
{
    ...
    public function view($id=null) {
        ...
        $data['title'] = 'View';
        $data['content']  = view('receptionist/user/view',$data);
    ...
    public function edit($id) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'Edit';
        $data['content']  = view('receptionist/user/edit',$data);
        return view('receptionist/layout/main_wrapper',$data);
    }
    ...
    public function update($id=null) {
        ...
        if ($this->user_model->save($user)) {
            return redirect()->to("/receptionist/user/view/$id")->with('info', 'User Info updated successfully');
        } else {
    ...
    public function reset_password() {
        $data['heading'] = $this->heading;
        $data['title'] = 'Password';
        $data['content']  = view('receptionist/user/reset_password',$data);
        return view('receptionist/layout/main_wrapper',$data);
    }
    ...
    public function update_password() {
        ...
        if ($this->user_model->save($user)) {
        return redirect()->to("/receptionist/user/view/$user_id")->with('info', 'User Info updated successfully');
        } else {
        return redirect()->back()->with('error', $user_model->errors)->with('error', 'Invalid data');
        }
    }
