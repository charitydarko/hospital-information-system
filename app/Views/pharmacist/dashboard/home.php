    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
        ...
        <div class="small-box bg-aqua">
            ...
            <div class="icon">
                ...
                <a href="<?= base_url("pharmacist/patient") ?>" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
        ...
        <div class="small-box bg-green">
            ...
            <div class="icon">
                ...
                <a href="<?= base_url("pharmacist/appointment") ?>" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
</div>
                            ...
                            <?php foreach ($notice as $item) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td class="center" width="80">
                                        <a href="<?= site_url("pharmacist/noticeboard/view/".$item->id)?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a> 
                                    </td> 
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
                        ...
                        <?php if (!empty($messages)) { ?>
                            ...
                            <?php foreach ($messages as $message) { ?>
                                <tr>
                                    ...
                                    <td class="center" width="80">
                                        <a href="<?php echo base_url("pharmacist/message/inbox_information_inbox/$message->id") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a> 
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
