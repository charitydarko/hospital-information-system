    ...
    <div class="col-sm-12" id="PrintMe">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group">   
                    <a class="btn btn-primary" href="<?php echo base_url("pharmacist/patient") ?>"> <i class="fa fa-list"></i> Patient List</a>  
                                                ...
                                                <?php if (!empty($appointments)) { ?>
                                                    ...
                                                    <?php foreach ($appointments as $appointment) { ?>
                                                        <tr class="<?= ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                                            ...
                                                            <td class="center">
                                                                <a href="<?=site_url("/pharmacist/appointment/view/".$appointment->appointment_id)?>" class="btn btn-xs btn-success" title="View Patient Appointment"><i class="fa fa-eye"></i></a>
                                                            </td>
                                                        </tr>
                                                        <?php $sl++; ?>
                                                    <?php } ?> 
