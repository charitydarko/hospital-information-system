  ...
  <div class="col-sm-12">
    <div  class="panel panel-bd">
      ...
      <div class="panel-heading no-print">
        ...
        <div class="btn-group m-t-10 m-b-5">
          <a class="btn btn-primary" href="<?php echo base_url("human_resources/employee/index/doctor") ?>">
        ...
        <div class="btn-group m-t-10 m-b-5">
          <a class="btn btn-primary" href="<?php echo base_url("human_resources/employee/index/laboratorist") ?>">
            <i class="fa fa-list"></i> Laboratorist List
          </a>
        </div>
        <div class="btn-group m-t-10 m-b-5">
          <a class="btn btn-primary" href="<?php echo base_url("human_resources/employee/index/cashier") ?>">
            <i class="fa fa-list"></i> Cashier List
          </a>
        </div>
        <div class="btn-group m-t-10 m-b-5">
          <a class="btn btn-primary" href="<?php echo base_url("human_resources/employee/index/accountant") ?>">
            <i class="fa fa-list"></i> Accountant List
          </a>
        </div>
        <div class="btn-group m-t-10 m-b-5">
          <a class="btn btn-primary" href="<?php echo base_url("humanresources/employee/index/admin") ?>">
      ...
      <div class="panel-body panel-form">
        <div  class="row">
          <div class="col-md-9 col-sm-12">
            <form action="<?php echo base_url(); ?>/humanresources/employee" method="post">
              <?= csrf_field() ?>
