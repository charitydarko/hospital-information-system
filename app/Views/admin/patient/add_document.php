  ...
  <div class="col-sm-12">
    <div class="panel panel-default thumbnail">
      ...
      <div class="panel-heading">
        <div class="btn-group">
          <a class="btn btn-success" href="<?php echo base_url("admin/patient/document") ?>"> <i class="fa fa-list"></i> Document List</a> 
        </div>
      </div>
      ...
      <div class="panel-body">
        <div class="row">
          ...
          <div class="col-md-9 col-sm-12">
            <form action=<?= base_url("/admin/patient/document_upload") ?> method="post" enctype="multipart/form-data">
              <?= csrf_field() ?>
