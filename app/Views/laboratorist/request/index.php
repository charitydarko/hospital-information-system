                        ...
                        <?php if (!empty($diagnosis) && !empty($loadLaboratory)) { ?>
                            ...
                            <?php foreach ($diagnosis as $diag) { ?>
                                <tr class="<?= ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td class="center">
                                        <a href="<?=site_url("/laboratorist/request/view/".$diag->id)?>" class="btn btn-xs btn-success" title="View Laboratory Request"><i class="fa fa-eye"></i></a>
                                        <a href="<?=site_url("/laboratorist/request/edit/".$diag->id)?>" class="btn btn-xs btn-primary" title="Edit Laboratory Request"><i class="fa fa-edit"></i></a>
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
