...
class Patient extends BaseController
{
    ...
    public function today() {
      ...
      $data['content']  = view('admin/patient/today',$data);
      return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function view($registration_code = null) {
      ...
      $data['heading'] = $this->heading;
      $data['title'] = 'View';
      $data['content']  = view('admin/patient/view',$data);
      return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function new() {
      $data['heading'] = $this->heading;
      $data['title'] = 'Add';
      $data['content'] = view('admin/patient/new');
      return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function edit($registration_code = null) {
      ...
      $data['heading'] = $this->heading;
      $data['title'] = 'Edit';
      $data['content']  = view('admin/patient/edit',$data);
      return view('admin/layout/main_wrapper',$data);
    }
     ...
     public function update($registration_code = null) {
      ...
      if ($this->patient_model->save($patient)) {
        return redirect()->to("/admin/patient/view/$registration_code")->with('info', 'Task updated successfully');
      } else {
    ...
    public function document(){
      ...
      $data['title'] = 'List';
      $data['content'] = view('admin/patient/document', $data);
      return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function add_document($registration_code = null){
      ...
      $data['content'] = view('admin/patient/add_document', $data);
      return view('admin/layout/main_wrapper',$data);
    }
