    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary" href="<?= base_url("admin/pharmacy/inventory") ?>"> <i class="fa fa-list"></i>  Sales List </a>  
                </div>
            </div> 
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 table-responsive">
                        <?php $billing_id = $prescription_sale->id; ?>
                        <form action=<?= "/admin/pharmacy/inventory/update/$billing_id" ?> method="post">
                            <?= csrf_field() ?>
                                        ...
                                        <th width="40%">
                                            <ul class="list-unstyled">
                                                <li>
                                                    ...
                                                    <input type="text" required name="appointment_code" id="appointment_code" class="invoice-input" value="<?= $prescription_sale->appointment_id; ?>" disabled />
                                                    <input type="hidden" required name="appointment_code" id="appointment_code" class="invoice-input" value="<?= $prescription_sale->appointment_id; ?>" />
                            ...
                            <table id="invoice" class="table table-striped"> 
                                ...
                                <tbody>
                                    ...
                                    <?php 
                                    if(!empty($prescription_sale_details)) { 
                                    foreach ($prescription_sale_details as $prescription_sale_detail) { 
                                    ?>
                                    <tr>
                                        <td><input type="text" name="item_name[]" required autocomplete="off" class="totalCal form-control" placeholder="Item Name" value="<?= esc($prescription_sale_detail->item_name); ?>" ></td>
                                        <td><textarea name="description[]" class="form-control" placeholder="Description"><?= esc($prescription_sale_detail->description); ?></textarea></td> 
                                        <td><input type="number" name="quantity[]" required autocomplete="off" class="totalCal form-control" placeholder="Quantity" value="<?= esc($prescription_sale_detail->quantity); ?>" ></td>  
                                        <td><input type="number" name="price[]" required autocomplete="off" class="totalCal form-control" placeholder="Price" value="<?= esc($prescription_sale_detail->price); ?>"></td>  
                                        <td><input type="number" name="subtotal[]" required readonly autocomplete="off" class="subtotal form-control" placeholder="Subtotal" value="<?= esc($prescription_sale_detail->subtotal); ?>"></td>   
                                ...
                                <tr class="bg-info">  
                                        ...
                                        <th><input type="float" name="total" id="total" class="form-control" readonly required placeholder="Total"  value="<?= $prescription_sale->total ?>"></th>  
                                        <td></td> 
                                    </tr>
                                    <tr>  
                                        ...
                                        <td><input type="float" name="tax" id="vat" autocomplete="off"  class="vatDiscount paidDue form-control" placeholder="Vat"  value="<?= $prescription_sale->tax ?>"></td>  
                                        <td></td> 
                                    </tr>
                                    <tr>  
                                        ...
                                        <td>
                                            <input type="float" name="discount" required autocomplete="off" id="discount" class="vatDiscount paidDue form-control" placeholder="Discount"  value="<?= $prescription_sale->discount ?>">
                                        </td> 
                                        <td></td>  
                                    </tr> 
                                    <tr class="bg-success">  
