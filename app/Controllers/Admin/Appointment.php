...
class Appointment extends BaseController
{
    ...
    public function add() {
        $data['heading'] = $this->heading;
        $data['title'] = 'Add';
        $data['content']  = view('admin/appointment/add',$data);
        return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function view($id) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'Profile';
        $data['content']  = view('admin/appointment/view',$data);
        return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function edit($id) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'Edit';
        $data['content']  = view('admin/appointment/edit',$data);
        return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function update($id) {
        ...
        if ($this->appointment_model->save($appointment)) {
          return redirect()->to("/admin/appointment/view/$id")->with('info', 'Appointment updated successfully');
        } else {
          return redirect()->back()->with('error', $appointment_model->errors)->with('error', 'Invalid data');
        }
    }
    ...
    public function delete($id) {
        ...
        return redirect()->to( base_url('admin/appointment'))->with('info', 'Appointment deleted successfully');
    }
