    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
        ...
        <div class="small-box bg-green">
            ...
            <div class="icon">
                ...
                <a href="<?= base_url("appointment") ?>" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
        <div class="small-box bg-blue">
            ...
            <div class="icon">
                ...
                <a href="<?= base_url("user/index/2") ?>" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
         <div class="small-box bg-yellow">
            ...
            <div class="icon">
                ...
                <a href="<?= base_url("pharmacy/prescription/request") ?>" class="small-box-footer">More Info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
</div>
                        ...
                        <?php if (!empty($messages)) { ?>
                            ...
                            <?php foreach ($messages as $message) { ?>
                                <tr>
                                    ...
                                    <td class="center" width="80">
                                        <a href="<?php echo base_url("message/inbox_information_inbox/$message->id") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a> 
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
