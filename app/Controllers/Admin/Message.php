...
class Message extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['content'] = view('admin/message/index', $data);
    ...
    public function add()
    {
        ...
        $data['content'] = view('admin/message/add', $data);
		return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function sent() {
        ...
        $data['user'] = $this->user_model;
        $data['content'] = view('admin/message/sent', $data);
		return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function inbox_information($id = null) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'View';
        $data['content']  = view('admin/message/view',$data);
        return view('admin/layout/main_wrapper',$data);
    }
