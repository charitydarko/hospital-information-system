...
class Message extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['content'] = view('cashier/message/index', $data);
    ...
    public function add()
    {
        ...
        $data['content'] = view('cashier/message/add', $data);
		return view('cashier/layout/main_wrapper',$data);
    }
    ...
    public function sent() {
        ...
        $data['user'] = $this->user_model;
        $data['content'] = view('cashier/message/sent', $data);
		return view('cashier/layout/main_wrapper',$data);
    }
    ...
    public function inbox_information($id = null) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'View';
        $data['content']  = view('cashier/message/view',$data);
        return view('cashier/layout/main_wrapper',$data);
    }
