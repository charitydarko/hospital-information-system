    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary" href="<?= base_url("pharmacy/inventory") ?>"> <i class="fa fa-list"></i>  Sales List </a>  
                </div>
            </div> 
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 table-responsive">
                        ...
                        <form action=<?= "/pharmacy/inventory/update/$billing_id" ?> method="post">
                            <?= csrf_field() ?>
