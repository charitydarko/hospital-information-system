    ...
    <div class="col-sm-12" id="PrintMe">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-success" href="<?php echo base_url("/admin/patient/new") ?>"> <i class="fa fa-plus"></i> Add Patient</a>  
                    <a class="btn btn-primary" href="<?php echo base_url("admin/patient") ?>"> <i class="fa fa-list"></i> Patient List</a>  
                                            ...
                                            <?php foreach ($documents as $document) { ?>
                                                <tr>
                                                    ...
                                                    <a target="_blank" href="<?php echo base_url('./uploads/patient/documents/'.$document->hidden_attach_file) ?>" class="btn btn-xs btn-info" title="View Patient Document"><i class="fa fa-eye"></i></a>
                                                        ...
                                                        <a href="<?php echo base_url("admin/patient/add_document/$document->patient_id") ?>" class="btn btn-xs btn-warning" title="Add Patient Document"><i class="fa fa-plus"></i></a>
                                                        ...
                                                        <a href="<?php echo base_url("admin/patient/document_delete/$document->id?file=$document->hidden_attach_file") ?>" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure?') " title="Delete Patient Document"><i class="fa fa-trash"></i></a> 
                                                    </td>
                                                </tr>
                                                <?php $sl++; ?>
                                            <?php } ?> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div  class="panel panel-default thumbnail">
                                    ...
                                    <div class="panel-heading no-print">
                                        <div class="btn-group"> 
                                            <a class="btn btn-success" href="<?php echo base_url("/admin/appointment/add") ?>"> <i class="fa fa-plus"></i>  Add Appointment </a>  
                                        </div>
                                    </div> 
                                    <div class="panel-body">
                                        <table width="100%" class="datatable table table-striped table-bordered table-hover">
                                                ...
                                                <?php if (!empty($appointments)) { ?>
                                                    ...
                                                    <?php foreach ($appointments as $appointment) { ?>
                                                        <tr class="<?= ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                                            ...
                                                            <td class="center">
                                                                <a href="<?=site_url("/admin/appointment/view/".$appointment->appointment_id)?>" class="btn btn-xs btn-success" title="View Patient Appointment"><i class="fa fa-eye"></i></a>

                                                                <a href="<?=site_url("/admin/vitals/add/".$appointment->appointment_id)?>" class="btn btn-xs btn-warning" title="Add Patient Vitals"><i class="fa fa-heart-pulse"></i></a> 

                                                                <a href="<?=site_url("/admin/appointment/edit/".$appointment->appointment_id)?>" class="btn btn-xs btn-primary" title="Edit Patient Appointment"><i class="fa fa-edit"></i></a> 

                                                                <a href="<?=site_url("/admin/appointment/delete/".$appointment->appointment_id)?>" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure?')" title="Delete Patient Appointment"><i class="fa fa-trash"></i></a> 
                                                            </td>
                                                        </tr>
                                                        <?php $sl++; ?>
                                                    <?php } ?> 
