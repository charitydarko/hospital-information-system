...
class Billing extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['title'] = 'List';
        $data['content']  = view('cashier/billing/index',$data);
    ...
    public function edit($id=null) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'Edit';
        $data['content']  = view('cashier/billing/edit',$data);
        return view('cashier/layout/main_wrapper',$data);
    }
    ...
    public function update($id = null) {
        ...
        if ($this->billing_model->save($invoice)) {
            ...
            return redirect()->to(base_url("cashier/billing"))->with('info', 'Billing updated successfully');
        } else {
    ...
    public function view($id=null) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'View';
        $data['content']  = view('cashier/billing/view',$data);
        return view('cashier/layout/main_wrapper',$data);
    }
    ...
    public function delete($id = null)  {
        ...
        return redirect()->to(base_url('cashier/billing'))->with('info', 'Billing Deleted successfully');
    }
