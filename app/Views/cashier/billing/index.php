                        ...
                        <?php if (!empty($billings)) { ?>
                            ...
                            <?php foreach ($billings as $billing) { ?>
                                <tr class="<?= ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td class="center">
                                        <a href="<?=site_url("cashier/billing/view/".$billing->id)?>" class="btn btn-xs btn-success" title="View Billing"><i class="fa fa-eye"></i></a>
                                        <a href="<?=site_url("cashier/billing/edit/".$billing->id)?>" class="btn btn-xs btn-primary" title="Edit Billing"><i class="fa fa-edit"></i></a> 
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
