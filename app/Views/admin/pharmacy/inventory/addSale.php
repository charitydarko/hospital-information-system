            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 table-responsive">
                        <form action="/admin/pharmacy/inventory/createSale" method="post">
                            <?= csrf_field() ?>
                                        ...
                                        <th width="40%">
                                            <ul class="list-unstyled">
                                                <li>
                                                    ...
                                                    <input type="hidden" name="payment_method" id="payment_method" class="invoice-input" value="pharmacy_sale">
                            ...
                            <table id="invoice" class="table table-striped"> 
                                ...
                                <tfoot> 
                                    <tr class="bg-info">  
                                        ...
                                        <th><input type="float" name="total" id="total" class="form-control" readonly required placeholder="Total"  value="0.00"></th>  
                                        <td></td> 
                                    </tr>
                                    <tr>  
                                        ...
                                        <td><input type="float" name="vat" id="vat" required autocomplete="off"  class="vatDiscount paidDue form-control" placeholder="Vat" value="0.00" min="0"></td>  
                                        <td></td> 
                                    </tr>
                                    <tr>  
                                        ...
                                        <td>
                                            <input type="float" name="discount" required autocomplete="off" id="discount" class="vatDiscount paidDue form-control" placeholder="Discount"  value="0.00" min="0">
                                        </td> 
                                        <td></td>  
                                    </tr> 
                                    <tr class="bg-success">  
