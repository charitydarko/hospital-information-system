        ...
        <div class="panel panel-default thumbnail">
            <div class="panel-heading">
                <div class="btn-group">
                    ...
                    <a class="btn btn-primary" href="<?php echo base_url("receptionist/message/") ?>"> <i class="fa fa-inbox"></i>  Inbox </a>
                </div>
            </div>
                            ...
                            <?php foreach ($messages as $message) { ?>
                                <tr>
                                    ...
                                    <td class="center" width="80">
                                        <a href="<?php echo base_url("receptionist/message/inbox_information/$message->id") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a> 
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
