...
class User extends BaseController
{
    ...
    public function view($id=null) {
        ...
        $data['title'] = 'View';
        $data['content']  = view('pharmacist/user/view',$data);
    ...
    public function edit($id) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'Edit';
        $data['content']  = view('pharmacist/user/edit',$data);
        return view('pharmacist/layout/main_wrapper',$data);
    }
    ...
    public function update($id=null) {
        ...
        if ($this->user_model->save($user)) {
            return redirect()->to("/pharmacist/user/view/$id")->with('info', 'User Info updated successfully');
        } else {
    ...
    public function reset_password() {
        $data['heading'] = $this->heading;
        $data['title'] = 'Password';
        $data['content']  = view('pharmacist/user/reset_password',$data);
        return view('pharmacist/layout/main_wrapper',$data);
    }
    ...
    public function update_password() {
        ...
        if ($this->user_model->save($user)) {
        return redirect()->to("/pharmacist/user/view/$user_id")->with('info', 'User Info updated successfully');
        } else {
        return redirect()->back()->with('error', $user_model->errors)->with('error', 'Invalid data');
        }
    }
