...
class Patient extends BaseController
{
    ...
    public function today() {
        ...
        $data['content']  = view('receptionist/patient/today',$data);
        return view('receptionist/layout/main_wrapper',$data);
      }
      ...
      public function view($registration_code = null) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'View';
        $data['content']  = view('receptionist/patient/view',$data);
        return view('receptionist/layout/main_wrapper',$data);
      }
      ...
      public function new() {
        $data['heading'] = $this->heading;
        $data['title'] = 'Add';
        $data['content'] = view('receptionist/patient/new');
        return view('receptionist/layout/main_wrapper',$data);
      }
      ...
      public function edit($registration_code = null) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'Edit';
        $data['content']  = view('receptionist/patient/edit',$data);
        return view('receptionist/layout/main_wrapper',$data);
      }
       ...
       public function update($registration_code = null) {
        ...
        if ($this->patient_model->save($patient)) {
          return redirect()->to("receptionist/patient/view/$registration_code")->with('info', 'Task updated successfully');
        } else {
      ...
      public function document(){
        ...
        $data['title'] = 'List';
        $data['content'] = view('receptionist/patient/document', $data);
        return view('receptionist/layout/main_wrapper',$data);
      }
      ...
      public function add_document($registration_code = null){
        ...
        $data['content'] = view('receptionist/patient/add_document', $data);
        return view('receptionist/layout/main_wrapper',$data);
      }
      ...
      public function document_delete($registration_code=null, $file=null) {
        ...
        return redirect()->to( base_url('receptionist/patient/document'))->with('info', 'Deleted successfully');
      }
