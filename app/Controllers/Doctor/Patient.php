...
class Patient extends BaseController
{
    ...
    public function index(){
      ...
      $data['title'] = 'List';
      $data['content']  = view('doctor/patient/index',$data);
    ...
    public function today() {
        ...
        $data['content']  = view('doctor/patient/today',$data);
        return view('doctor/layout/main_wrapper',$data);
      }
      ...
      public function view($registration_code = null) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'View';
        $data['content']  = view('doctor/patient/view',$data);
        return view('doctor/layout/main_wrapper',$data);
      }
      ...
      public function new() {
        $data['heading'] = $this->heading;
        $data['title'] = 'Add';
        $data['content'] = view('doctor/patient/new');
        return view('doctor/layout/main_wrapper',$data);
      }
      ...
      public function edit($registration_code = null) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'Edit';
        $data['content']  = view('doctor/patient/edit',$data);
        return view('doctor/layout/main_wrapper',$data);
      }
       ...
       public function update($registration_code = null) {
        ...
        if ($this->patient_model->save($patient)) {
          return redirect()->to("/doctor/patient/view/$registration_code")->with('info', 'Task updated successfully');
        } else {
      ...
      public function document(){
        ...
        $data['title'] = 'List';
        $data['content'] = view('doctor/patient/document', $data);
        return view('doctor/layout/main_wrapper',$data);
      }
      ...
      public function add_document($registration_code = null){
        ...
        $data['content'] = view('doctor/patient/add_document', $data);
        return view('doctor/layout/main_wrapper',$data);
      }
      ...
      public function delete($registration_code) {
        ...
        return redirect()->to( base_url('doctor/patient') );
      }
      ...
      public function document_delete($registration_code=null, $file=null) {
        ...
        return redirect()->to( base_url('doctor/patient/document'))->with('info', 'Deleted successfully');
      }
