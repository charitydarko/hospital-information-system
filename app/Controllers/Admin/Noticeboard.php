...
class Noticeboard extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['content'] = view('admin/noticeboard/index', $data);
    ...
    public function add() {
        ...
        $data['content'] = view('admin/noticeboard/add', $data); 
        return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function view($id=null) {
        ...
        $data['staff'] = $this->user_model;
        $data['title'] = 'View';
        $data['content']  = view('admin/noticeboard/view',$data);
        return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function edit($id) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'Edit';
        $data['content']  = view('admin/noticeboard/edit',$data);
        return view('admin/layout/main_wrapper',$data);
    }
      ...
      public function update($id=null) {
        ...
        if ($this->noticeboard_model->save($notice)) {
          return redirect()->to("/admin/noticeboard/view/$id")->with('info', 'Notice updated successfully');
        } else {
    ...
    public function delete($id) {
        ...
        return redirect()->to( base_url('admin/noticeboard'));
    }
