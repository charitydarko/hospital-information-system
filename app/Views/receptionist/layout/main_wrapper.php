    ...
    <aside class="main-sidebar">
      ...
      <div class="sidebar">
        ...
        <ul class="sidebar-menu">
          <li class="">
            <a href="<?= base_url('receptionist/dashboard'); ?>"><i class="fa fa ti-home"></i> Dashboard</a>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("receptionist/patient/new") ?>">Add Patient</a></li>
              <li><a href="<?= base_url("receptionist/patient/today") ?>">Added Today</a></li>
              <li><a href="<?= base_url("receptionist/patient") ?>">List All Patients</a></li> 
              <li><a href="<?= base_url("receptionist/patient/document") ?>">List Documents</a></li> 
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("receptionist/appointment/add") ?>">Add Appointment</a></li>
              <li><a href="<?= base_url("receptionist/appointment/today") ?>">Added Today</a></li>
              <li><a href="<?= base_url("receptionist/appointment") ?>">List All Appointments</a></li> 
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("receptionist/vitals/add") ?>">Capture Vitals</a></li>
              <li><a href="<?= base_url("receptionist/vitals/today") ?>">Added Today</a></li>
              <li><a href="<?= base_url("receptionist/vitals") ?>">View Vitals List</a></li> 
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("receptionist/message/add") ?>">New Message</a></li>
              <li><a href="<?= base_url("receptionist/message/") ?>">Inbox</a></li>
              <li><a href="<?= base_url("receptionist/message/sent") ?>">Sent</a></li>
            </ul>
          </li>
        </ul>
      </div>
