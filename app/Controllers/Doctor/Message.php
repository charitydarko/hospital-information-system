...
class Message extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['content'] = view('doctor/message/index', $data);
    ...
    public function add()
    {
        ...
        $data['content'] = view('doctor/message/add', $data);
		return view('doctor/layout/main_wrapper',$data);
    }
    ...
    public function sent() {
        ...
        $data['user'] = $this->user_model;
        $data['content'] = view('doctor/message/sent', $data);
		return view('doctor/layout/main_wrapper',$data);
    }
    ...
    public function inbox_information($id = null) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'View';
        $data['content']  = view('doctor/message/view',$data);
        return view('doctor/layout/main_wrapper',$data);
    }
