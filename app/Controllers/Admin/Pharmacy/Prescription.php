...
class Prescription extends BaseController
{
    ...
    public function request()
    {
        ...
        $data['title'] = 'Requests';
        $data['content']  = view('admin/pharmacy/prescription/index',$data);
    ...
    public function view($id = null)
    {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'View';
        $data['content']  = view('admin/pharmacy/prescription/view',$data);
        return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function edit($id = null) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'View';
        $data['content']  = view('admin/pharmacy/prescription/edit',$data);
        return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function update($id = null){
        ...
        if ($this->prescription_model->save($prescription)) {
            return redirect()->to("/admin/pharmacy/prescription/request")->with('info', 'Prescription updated successfully');
        } else {
    ...
    public function delete($id = null)  {
        ...
        return redirect()->to(base_url('/admin/pharmacy/prescription/request'))->with('info', 'Prescription deleted successfully');
    }
