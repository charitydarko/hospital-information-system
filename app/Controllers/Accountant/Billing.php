...
class Billing extends BaseController
{
    ...
    public function add($id=null) {
        ...
        $data['content']  = view('accountant/billing/add',$data);
        return view('accountant/layout/main_wrapper',$data);
    }
    ...
    public function edit($id=null) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'Edit';
        $data['content']  = view('accountant/billing/edit',$data);
        return view('accountant/layout/main_wrapper',$data);
    }
    ...
    public function update($id = null) {
        ...
        if ($this->billing_model->save($invoice)) {
            ...
            return redirect()->to(base_url("accountant/billing"))->with('info', 'Billing updated successfully');
        } else {
    ...
    public function view($id=null) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'View';
        $data['content']  = view('accountant/billing/view',$data);
        return view('accountant/layout/main_wrapper',$data);
    }
    ...
    public function delete($id = null)  {
        ...
        return redirect()->to(base_url('accountant/billing'))->with('info', 'Billing Deleted successfully');
    }
