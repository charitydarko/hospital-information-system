  ...
  <div class="col-sm-12">
    <div class="panel panel-default thumbnail">
      ...
      <div class="panel-heading">
        <div class="btn-group">
          <a class="btn btn-primary" href="<?php echo base_url("doctor/diagnosis") ?>"> <i class="fa fa-list"></i> Diagnosis List</a> 
        </div>
      </div>
      ...
      <div class="panel-body">
          ...
          <br/><br/>
          <div class="row">
              <form action=<?= "/doctor/diagnosis/update/$diagnosis->appointment_id"?> method="post" >
                  <?= csrf_field() ?>
