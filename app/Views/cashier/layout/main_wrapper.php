          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown dropdown-user">
              ...
              <ul class="dropdown-menu">
                  <li><a href="<?= base_url("cashier/user/view/".session()->get('id'))?>"><i class="pe-7s-users"></i>Profile</a></li>
                  <li><a href="<?= base_url("cashier/user/edit/".session()->get('id'))?>"><i class="pe-7s-settings"></i>Edit Profile</a></li>
                  <li><a href="<?= base_url("cashier/user/reset_password")?>"><i class="pe-7s-key"></i>Update Password</a></li>
    ...
    <aside class="main-sidebar">
      ...
      <div class="sidebar">
        ...
        <ul class="sidebar-menu">
          <li class="">
            <a href="<?= base_url('cashier/dashboard'); ?>"><i class="fa fa ti-home"></i> Dashboard</a>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("cashier/patient/today") ?>">Added Today</a></li>
              <li><a href="<?= base_url("cashier/patient") ?>">List All Patients</a></li> 
              <li><a href="<?= base_url("cashier/patient/document") ?>">List Documents</a></li> 
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("cashier/appointment/today") ?>">Added Today</a></li>
              <li><a href="<?= base_url("cashier/appointment") ?>">List All Appointments</a></li> 
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("cashier/billing/add") ?>">Add Invoice</a></li>
              <li><a href="<?= base_url("cashier/billing/today") ?>">Added Today</a></li>
              <li><a href="<?= base_url("cashier/billing") ?>">Invoice List</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("cashier/noticeboard/index") ?>">Notice List</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("cashier/message/add") ?>">New Message</a></li>
              <li><a href="<?= base_url("cashier/message/") ?>">Inbox</a></li>
              <li><a href="<?= base_url("cashier/message/sent") ?>">Sent</a></li>
            </ul>
          </li>
        </ul>
      </div>
