...
class Diagnosis extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['title'] = 'List';
        $data['content']  = view('admin/diagnosis/index',$data);
    ...
    public function add($id=null) {
        ...
        $data['content']  = view('admin/diagnosis/add',$data);
        return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function view($id = null) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'View';
        $data['content']  = view('admin/diagnosis/view',$data);
        return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function edit($id = null) {
        ...
        $data['patient'] = $this->getPatientOr404($data['appointment']->patient_id);
        $data['content']  = view('admin/diagnosis/edit',$data);
        return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function update($id) {
        ...
        if ($this->diagnosis_model->save($diagnosis)) {
            return redirect()->to("/admin/diagnosis/view/$id")->with('info', 'Diagnosis updated successfully');
        } else {
            return redirect()->back()->with('error', $diagnosis_model->errors)->with('error', 'Invalid data');
        }
    }
    ...
    public function delete($id) {
        ...
        return redirect()->to( base_url('admin/diagnosis'))->with('info', 'Diagnosis deleted successfully');
    }
