...
class Vitals extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['content']  = view('receptionist/vitals/index',$data);
    ...
    public function today()
    {
        ...
        $data['content']  = view('receptionist/vitals/today',$data);
        return view('receptionist/layout/main_wrapper',$data);
    }
    ...
    public function add($id=null)
    {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'Add';
        $data['content']  = view('receptionist/vitals/add',$data);
        return view('receptionist/layout/main_wrapper',$data);
    }
    ...
    public function edit($id) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'Edit';
        $data['content']  = view('receptionist/vitals/edit',$data);
        return view('receptionist/layout/main_wrapper',$data);
    }
    ...
    public function update($id) {
        ...
        if ($this->vitals_model->save($vitals)) {
            return redirect()->to("/receptionist/vitals/view/$id")->with('info', 'Vitals updated successfully');
        } else {
            return redirect()->back()->with('error', $vitals_model->errors)->with('error', 'Invalid data');
        }
    }
    ...
    public function delete($id) {
        ...
        return redirect()->to( base_url('receptionist/receptionist/vitals'))->with('info', 'Appointment deleted successfully');
    }
