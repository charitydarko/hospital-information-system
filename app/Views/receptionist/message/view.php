    ...
    <div class="col-sm-12" id="PrintMe">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-success" href="<?=base_url("receptionist/message/add") ?>"> <i class="fa fa-paper-plane"></i> New Message</a>  
                    <a class="btn btn-primary" href="<?= base_url("receptionist/message/") ?>"> <i class="fa fa-inbox"></i> Inbox</a>  
