          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown dropdown-user">
              ...
              <ul class="dropdown-menu">
                  <li><a href="<?= base_url("admin/user/view/".session()->get('id'))?>"><i class="pe-7s-users"></i>Profile</a></li>
                  <li><a href="<?= base_url("admin/user/edit/".session()->get('id'))?>"><i class="pe-7s-settings"></i>Edit Profile</a></li>
                  <li><a href="<?= base_url("admin/user/reset_password")?>"><i class="pe-7s-key"></i>Update Password</a></li>
    ...
    <aside class="main-sidebar">
      ...
      <div class="sidebar">
        ...
        <ul class="sidebar-menu">
          <li class="">
            <a href="<?= base_url('admin/dashboard'); ?>"><i class="fa fa ti-home"></i> Dashboard</a>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("admin/patient/new") ?>">Add Patient</a></li>
              <li><a href="<?= base_url("admin/patient/today") ?>">Added Today</a></li>
              <li><a href="<?= base_url("admin/patient") ?>">List All Patients</a></li> 
              <li><a href="<?= base_url("admin/patient/document") ?>">List Documents</a></li> 
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("admin/appointment/add") ?>">Add Appointment</a></li>
              <li><a href="<?= base_url("admin/appointment/today") ?>">Added Today</a></li>
              <li><a href="<?= base_url("admin/appointment") ?>">List All Appointments</a></li> 
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("admin/vitals/add") ?>">Capture Vitals</a></li>
              <li><a href="<?= base_url("admin/vitals/today") ?>">Added Today</a></li>
              <li><a href="<?= base_url("admin/vitals") ?>">View Vitals List</a></li> 
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("admin/diagnosis/today") ?>">Added Today</a></li>
              <li><a href="<?= base_url("admin/diagnosis") ?>">Patient Diagnosis List</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("admin/pharmacy/inventory/sale") ?>">Add Sale</a></li>
              <li><a href="<?= base_url("admin/pharmacy/inventory/today") ?>">Added Today</a></li>
              <li><a href="<?= base_url("admin/pharmacy/inventory") ?>">List All Sales</a></li>
              <li><a href="<?= base_url("admin/pharmacy/prescription/request") ?>">Requests from Diagnosis</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("admin/billing/add") ?>">Add Invoice</a></li>
              <li><a href="<?= base_url("admin/billing/today") ?>">Added Today</a></li>
              <li><a href="<?= base_url("admin/billing") ?>">Invoice List</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("admin/noticeboard/add") ?>">Add Notice</a></li>
              <li><a href="<?= base_url("admin/noticeboard/index") ?>">Notice List</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("admin/message/add") ?>">New Message</a></li>
              <li><a href="<?= base_url("admin/message/") ?>">Inbox</a></li>
              <li><a href="<?= base_url("admin/message/sent") ?>">Sent</a></li>
            </ul>
          </li>
        </ul>
      </div>
