  ...
  <div class="col-sm-12">
    <div  class="panel panel-default thumbnail">
        ...
        <div class="panel-heading no-print">
            <div class="btn-group"> 
                <a class="btn btn-primary" href="<?= site_url("/doctor/noticeboard") ?>"> <i class="fa fa-list"></i> Notice List</a>  
            </div>
        </div> 
        ...
        <div class="panel-body panel-form">
          <div class="row">
              <div class="col-md-9 col-sm-12 ">
                <form action="/doctor/noticeboard/create" method="post" >
                  <?= csrf_field() ?>
                  <div class="form-group row">
                      ...
                      <div class="col-xs-9">
                          ...
                          <input name="created_by" type="hidden" class="form-control" id="created_by" placeholder="Title" value="<?= session()->get('id') ?>">
                      </div>
                  </div>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-xs-9">
                        <input name="start_date" class="form-control" type="date" placeholder="Start Date" id="start_date" value="<?= old('start_date') ?>">
                      </div>
                  </div>
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-xs-9">
                        <input name="end_date" class="form-control" type="date" placeholder="End Date" id="end_date" value="<?= old('end_date') ?>">
                      </div>
                  </div>
