...
class Request extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['title'] = 'Requests';
        $data['content']  = view('laboratorist/request/index',$data);
    ...
    public function view($id = null) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'View';
        $data['content']  = view('laboratorist/request/view',$data);
        return view('laboratorist/layout/main_wrapper',$data);
    }
    ...
    public function edit($id = null) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'View';
        $data['content']  = view('laboratorist/request/edit',$data);
        return view('laboratorist/layout/main_wrapper',$data);
    }
        ...
        if ($this->validate($rules)) {
            ...
            if($file->isValid() && !$file->hasMoved()) {
                ...
                if ($this->laboratory_model->save($laboratory)) {
                    return redirect()->to("/laboratorist/request")->with('info', 'Laboratory updated successfully');
                } else {
    ...
    public function delete($id = null)  {
        ...
        return redirect()->to( base_url('/laboratorist/request'))->with('info', 'Laboratory deleted successfully');
    }
