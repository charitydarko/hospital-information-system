                        ...
                        <?php if (!empty($appointments)) { ?>
                            ...
                            <?php foreach ($appointments as $appointment) { ?>
                                <tr class="<?= ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td class="center">
                                        <a href="<?=site_url("/receptionist/appointment/view/".$appointment->appointment_id)?>" class="btn btn-xs btn-success"><i class="fa fa-eye" title="View Appointment"></i></a>
                                        <a href="<?=site_url("/receptionist/vitals/add/".$appointment->appointment_id)?>" class="btn btn-xs btn-warning" title="Add Vitals"><i class="fa fa-heart-pulse"></i></a> 
                                        <a href="<?=site_url("/receptionist/appointment/edit/".$appointment->appointment_id)?>" class="btn btn-xs btn-primary" title="Edit Appointment"><i class="fa fa-edit"></i></a> 
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
