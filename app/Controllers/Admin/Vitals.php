...
class Vitals extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['content']  = view('admin/vitals/index',$data);
    ...
    public function add($id=null)
    {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'Add';
        $data['content']  = view('admin/vitals/add',$data);
        return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function view($id) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'View';
        $data['content']  = view('admin/vitals/view',$data);
        return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function edit($id) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'Edit';
        $data['content']  = view('admin/vitals/edit',$data);
        return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function update($id) {
        ...
        if ($this->vitals_model->save($vitals)) {
            return redirect()->to("/admin/vitals/view/$id")->with('info', 'Vitals updated successfully');
        } else {
            return redirect()->back()->with('error', $vitals_model->errors)->with('error', 'Invalid data');
        }
    }
