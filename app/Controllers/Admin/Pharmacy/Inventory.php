...
namespace App\Controllers\Admin\Pharmacy;
...
class Inventory extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['content']  = view('admin/pharmacy/inventory/index',$data);
    ...
    public function today()
    {
        ...
        $data['content']  = view('admin/pharmacy/inventory/today',$data);
        return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function sale()
    {
        ...
        $data['content'] = view('admin/pharmacy/inventory/AddSale', $data); 
        return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function view($id = null) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'View';
        $data['content']  = view('admin/pharmacy/inventory/view',$data);
        return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function edit($id = null) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'Edit';
        $data['content']  = view('admin/pharmacy/inventory/edit',$data);
        return view('admin/layout/main_wrapper',$data);
    }
    ...
    public function update($id = null) {
        ...
        if ($this->pharmacy_billing_model->save($prescription_sale)) {
            ...
            return redirect()->to(base_url("admin/pharmacy/inventory/index"))->with('info', 'Prescription updated successfully');
        } else {
    ...
    public function delete($id = null)  {
        ...
        return redirect()->to(base_url('/admin/pharmacy/inventory/index'))->with('info', 'Prescription Sale Deleted successfully');
    }
}
