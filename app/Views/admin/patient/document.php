    ...
    <div class="col-sm-12">
        <div class="panel panel-default thumbnail">
            ...
            <div class="panel-heading">
                <div class="btn-group">
                    <!-- <a class="btn btn-success" href="<?php echo base_url("admin/patient/add_document/") ?>"> <i class="fa fa-plus"></i> Add Document</a>   -->
                </div>
            </div>
                            ...
                            <?php foreach ($documents as $document) { ?>
                                <tr>
                                    ...
                                    <td class="center" width="80">
                                        ...
                                        <a href="<?php echo base_url("admin/patient/document_delete/$document->id?file=$document->hidden_attach_file") ?>" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure?') "  title="Delete Document"><i class="fa fa-trash"></i></a> 
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                            <?php } ?> 
