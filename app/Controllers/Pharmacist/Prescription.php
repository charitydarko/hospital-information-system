...
class Prescription extends BaseController
{
    ...
    public function request()
    {
        ...
        $data['title'] = 'Requests';
        $data['content']  = view('pharmacist/prescription/index',$data);
    ...
    public function view($id = null)
    {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'View';
        $data['content']  = view('pharmacist/prescription/view',$data);
        return view('pharmacist/layout/main_wrapper',$data);
    }
    ...
    public function edit($id = null) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'View';
        $data['content']  = view('pharmacist/prescription/edit',$data);
        return view('pharmacist/layout/main_wrapper',$data);
    }
    ...
    public function update($id = null){
        ...
        if ($this->prescription_model->save($prescription)) {
            return redirect()->to("/pharmacist/prescription/request")->with('info', 'Prescription updated successfully');
        } else {
    ...
    public function delete($id = null)  {
        ...
        return redirect()->to(base_url('/pharmacist/prescription/request'))->with('info', 'Prescription deleted successfully');
    }
