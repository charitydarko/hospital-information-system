...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    <header class="main-header">
      <a href="<?php echo base_url('pharmacist/dashboard') ?>" class="logo"> <!-- Logo -->
    ...
    <aside class="main-sidebar">
      ...
      <div class="sidebar">
        ...
        <ul class="sidebar-menu">
          <li class="">
            <a href="<?= base_url('pharmacist/dashboard'); ?>"><i class="fa fa ti-home"></i> Dashboard</a>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("pharmacist/patient/today") ?>">Added Today</a></li>
              <li><a href="<?= base_url("pharmacist/patient") ?>">List All Patients</a></li> 
              <li><a href="<?= base_url("pharmacist/patient/document") ?>">List Documents</a></li> 
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("pharmacist/appointment/today") ?>">Added Today</a></li>
              <li><a href="<?= base_url("pharmacist/appointment") ?>">List All Appointments</a></li> 
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("pharmacist/inventory/sale") ?>">Add Sale</a></li>
              <li><a href="<?= base_url("pharmacist/inventory/today") ?>">Added Today</a></li>
              <li><a href="<?= base_url("pharmacist/inventory") ?>">List All Sales</a></li>
              <li><a href="<?= base_url("pharmacist/prescription/request") ?>">Requests from Diagnosis</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("pharmacist/noticeboard/index") ?>">Notice List</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("pharmacist/message/add") ?>">New Message</a></li>
              <li><a href="<?= base_url("pharmacist/message/") ?>">Inbox</a></li>
              <li><a href="<?= base_url("pharmacist/message/sent") ?>">Sent</a></li>
            </ul>
          </li>
        </ul>
      </div>
