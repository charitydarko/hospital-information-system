...
$routes->group('', ['filter'=>'authGuard'], function($routes){
    ...
    $routes->get('admin/patient', 'Admin\Patient::index');
    $routes->get('admin/patient/today', 'Admin\Patient::today');
    $routes->get('admin/patient/view', 'Admin\Patient::view');
    $routes->get('admin/patient/view/(:any)', 'Admin\Patient::view/$1');
    $routes->get('admin/patient/new', 'Admin\Patient::new');
    $routes->get('admin/patient/create', 'Admin\Patient::create');
    $routes->get('admin/patient/create/(:any)', 'Admin\Patient::create/$1');
    $routes->get('admin/patient/edit', 'Admin\Patient::edit');
    $routes->get('admin/patient/edit/(:any)', 'Admin\Patient::edit/$1');
    $routes->get('admin/patient/update', 'Admin\Patient::update');
    $routes->get('admin/patient/update/(:any)', 'Admin\Patient::update/$1');
    $routes->get('admin/patient/document', 'Admin\Patient::document');
    $routes->get('admin/patient/add_document', 'Admin\Patient::add_document');
    $routes->get('admin/patient/add_document/(:any)', 'Admin\Patient::add_document/$1');
    $routes->get('admin/patient/document_upload', 'Admin\Patient::document_upload');
    $routes->get('admin/patient/document_upload/(:any)', 'Admin\Patient::document_upload/$1');
    $routes->get('admin/patient/delete', 'Admin\Patient::delete');
    $routes->get('admin/patient/delete/(:any)', 'Admin\Patient::delete/$1');
    $routes->get('admin/patient/document_delete', 'Admin\Patient::document_delete');
    $routes->get('admin/patient/document_delete/(:any)', 'Admin\Patient::document_delete/$1');
    $routes->get('admin/appointment', 'Admin\Appointment::index');
    $routes->get('admin/appointment/today', 'Admin\Appointment::today');
    $routes->get('admin/appointment/add', 'Admin\Appointment::add');
    $routes->get('admin/appointment/create', 'Admin\Appointment::create');
    $routes->get('admin/appointment/create/(:any)', 'Admin\Appointment::create/$1');
    $routes->get('admin/appointment/view', 'Admin\Appointment::view');
    $routes->get('admin/appointment/view/(:any)', 'Admin\Appointment::view/$1');
    $routes->get('admin/appointment/edit', 'Admin\Appointment::edit');
    $routes->get('admin/appointment/edit/(:any)', 'Admin\Appointment::edit/$1');
    $routes->get('admin/appointment/update', 'Admin\Appointment::update');
    $routes->get('admin/appointment/update/(:any)', 'Admin\Appointment::update/$1');
    $routes->get('admin/appointment/delete', 'Admin\Appointment::delete');
    $routes->get('admin/appointment/delete/(:any)', 'Admin\Appointment::delete/$1');
    $routes->get('admin/vitals', 'Admin\Vitals::index');
    $routes->get('admin/vitals/today', 'Admin\Vitals::today');
    $routes->get('admin/vitals/month', 'Admin\Vitals::month');
    $routes->get('admin/vitals/add', 'Admin\Vitals::add');
    $routes->get('admin/vitals/create', 'Admin\Vitals::create');
    $routes->get('admin/vitals/create/(:any)', 'Admin\Vitals::create/$1');
    $routes->get('admin/vitals/view', 'Admin\Vitals::view');
    $routes->get('admin/vitals/view/(:any)', 'Admin\Vitals::view/$1');
    $routes->get('admin/vitals/edit', 'Admin\Vitals::edit');
    $routes->get('admin/vitals/edit/(:any)', 'Admin\Vitals::edit/$1');
    $routes->get('admin/vitals/update', 'Admin\Vitals::update');
    $routes->get('admin/vitals/update/(:any)', 'Admin\Vitals::update/$1');
    $routes->get('admin/vitals/delete', 'Admin\Vitals::create');
    $routes->get('admin/vitals/delete/(:any)', 'Admin\Vitals::create/$1');
    $routes->get('admin/message', 'Admin\Message::index');
    $routes->get('admin/message/add', 'Admin\Message::add');
    $routes->get('admin/message/create', 'Admin\Message::create');
    $routes->get('admin/message/create/(:any)', 'Admin\Message::create/$1');
    $routes->get('admin/message/sent', 'Admin\Message::sent');
    $routes->get('admin/message/sent/(:any)', 'Admin\Message::sent/$1');
    $routes->get('admin/message/inbox_information', 'Admin\Message::inbox_information');
    $routes->get('admin/message/inbox_information/(:any)', 'Admin\Message::inbox_information/$1');
    $routes->get('admin/message/inbox_information_inbox', 'Admin\Message::inbox_information_inbox');
    $routes->get('admin/message/inbox_information_inbox/(:any)', 'Admin\Message::inbox_information_inbox/$1');
    $routes->get('admin/noticeboard', 'Admin\Noticeboard::index');
    $routes->get('admin/noticeboard/view', 'Admin\Noticeboard::view');
    $routes->get('admin/noticeboard/view/(:any)', 'Admin\Noticeboard::view/$1');
    $routes->get('admin/noticeboard/edit', 'Admin\Noticeboard::edit');
    $routes->get('admin/noticeboard/edit/(:any)', 'Admin\Noticeboard::edit/$1');
    $routes->get('admin/noticeboard/update', 'Admin\Noticeboard::update');
    $routes->get('admin/noticeboard/update/(:any)', 'Admin\Noticeboard::update/$1');
    $routes->get('admin/noticeboard/delete', 'Admin\Noticeboard::delete');
    $routes->get('admin/noticeboard/delete/(:any)', 'Admin\Noticeboard::delete/$1');
    $routes->get('admin/user', 'Admin\User::index');
    $routes->get('admin/user/list', 'Admin\User::list');
    $routes->get('admin/user/create', 'User::create');
    $routes->get('admin/user/view', 'Admin\User::view');
    $routes->get('admin/user/view/(:any)', 'Admin\User::view/$1');
    $routes->get('admin/user/edit', 'Admin\User::edit');
    $routes->get('admin/user/edit/(:any)', 'Admin\User::edit/$1');
    $routes->get('admin/user/update', 'Admin\User::update');
    $routes->get('admin/user/update/(:any)', 'Admin\User::update/$1');
    $routes->get('admin/user/delete', 'Admin\User::delete');
    $routes->get('admin/user/delete/(:any)', 'Admin\User::delete/$1');
    $routes->get('admin/user/reset_password', 'Admin\User::reset_password');
    $routes->get('admin/user/reset_password/(:any)', 'Admin\User::reset_password/$1');
    $routes->get('admin/user/update_password', 'Admin\User::update_password');
    $routes->get('admin/user/update_password/(:any)', 'Admin\User::update_password/$1');
});
