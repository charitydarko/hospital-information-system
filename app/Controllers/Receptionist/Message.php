...
class Message extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['content'] = view('receptionist/message/index', $data);
    ...
    public function add()
    {
        ...
        $data['content'] = view('receptionist/message/add', $data);
		return view('receptionist/layout/main_wrapper',$data);
    }
    ...
    public function sent() {
        ...
        $data['user'] = $this->user_model;
        $data['content'] = view('receptionist/message/sent', $data);
		return view('receptionist/layout/main_wrapper',$data);
    }
    ...
    public function inbox_information($id = null) {
        ...
        $data['heading'] = $this->heading;
        $data['title'] = 'View';
        $data['content']  = view('receptionist/message/view',$data);
        return view('receptionist/layout/main_wrapper',$data);
    }
