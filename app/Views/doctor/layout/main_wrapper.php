...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    <header class="main-header">
      <a href="<?php echo base_url('doctor/dashboard') ?>" class="logo"> <!-- Logo -->
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown dropdown-user">
              ...
              <ul class="dropdown-menu">
                  <li><a href="<?= base_url("doctor/user/view/".session()->get('id'))?>"><i class="pe-7s-users"></i>Profile</a></li>
                  <li><a href="<?= base_url("doctor/user/edit/".session()->get('id'))?>"><i class="pe-7s-settings"></i>Edit Profile</a></li>
                  <li><a href="<?= base_url("doctor/user/reset_password")?>"><i class="pe-7s-key"></i>Update Password</a></li>
    ...
    <aside class="main-sidebar">
      ...
      <div class="sidebar">
        ...
        <ul class="sidebar-menu">
          <li class="">
            <a href="<?= base_url('doctor/dashboard'); ?>"><i class="fa fa ti-home"></i> Dashboard</a>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("doctor/patient/new") ?>">Add Patient</a></li>
              <li><a href="<?= base_url("doctor/patient/today") ?>">Added Today</a></li>
              <li><a href="<?= base_url("doctor/patient") ?>">List All Patients</a></li> 
              <li><a href="<?= base_url("doctor/patient/document") ?>">List Documents</a></li> 
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("doctor/appointment/add") ?>">Add Appointment</a></li>
              <li><a href="<?= base_url("doctor/appointment/today") ?>">Added Today</a></li>
              <li><a href="<?= base_url("doctor/appointment") ?>">List All Appointments</a></li> 
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("doctor/vitals/add") ?>">Capture Vitals</a></li>
              <li><a href="<?= base_url("doctor/vitals/today") ?>">Added Today</a></li>
              <li><a href="<?= base_url("doctor/vitals") ?>">View Vitals List</a></li> 
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("doctor/diagnosis/today") ?>">Added Today</a></li>
              <li><a href="<?= base_url("doctor/diagnosis") ?>">Patient Diagnosis List</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("doctor/noticeboard/index") ?>">Notice List</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("doctor/message/add") ?>">New Message</a></li>
              <li><a href="<?= base_url("doctor/message/") ?>">Inbox</a></li>
              <li><a href="<?= base_url("doctor/message/sent") ?>">Sent</a></li>
            </ul>
          </li>
        </ul>
      </div>
