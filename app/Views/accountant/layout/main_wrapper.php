...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    <header class="main-header">
      <a href="<?php echo base_url('accountant/dashboard') ?>" class="logo"> <!-- Logo -->
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown dropdown-user">
              ...
              <ul class="dropdown-menu">
                  <li><a href="<?= base_url("accountant/user/view/".session()->get('id'))?>"><i class="pe-7s-users"></i>Profile</a></li>
                  <li><a href="<?= base_url("accountant/user/edit/".session()->get('id'))?>"><i class="pe-7s-settings"></i>Edit Profile</a></li>
                  <li><a href="<?= base_url("accountant/user/reset_password")?>"><i class="pe-7s-key"></i>Update Password</a></li>
    ...
    <aside class="main-sidebar">
      ...
      <div class="sidebar">
        ...
        <ul class="sidebar-menu">
          <li class="">
            <a href="<?= base_url('accountant/dashboard'); ?>"><i class="fa fa ti-home"></i> Dashboard</a>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("accountant/patient/today") ?>">Added Today</a></li>
              <li><a href="<?= base_url("accountant/patient") ?>">List All Patients</a></li> 
              <li><a href="<?= base_url("accountant/patient/document") ?>">List Documents</a></li> 
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("accountant/appointment/today") ?>">Added Today</a></li>
              <li><a href="<?= base_url("accountant/appointment") ?>">List All Appointments</a></li> 
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("accountant/billing/add") ?>">Add Invoice</a></li>
              <li><a href="<?= base_url("accountant/billing/today") ?>">Added Today</a></li>
              <li><a href="<?= base_url("accountant/billing") ?>">Invoice List</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("accountant/noticeboard/index") ?>">Notice List</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="<?= base_url("accountant/message/add") ?>">New Message</a></li>
              <li><a href="<?= base_url("accountant/message/") ?>">Inbox</a></li>
              <li><a href="<?= base_url("accountant/message/sent") ?>">Sent</a></li>
            </ul>
          </li>
        </ul>
      </div>
