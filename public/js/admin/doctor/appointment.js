$(document).ready(function() {
    ...
    $('#patient_id').on('keyup', function(){
        ...
        $.ajax({
            url  : _baseURL+'dashboard_doctor/appointment/appointment/check_patient/',
            type : 'post',
            dataType : 'JSON',
            data : {
    ...
    $("#department_id").on('change', function(){
        ...
        $.ajax({
            url  : _baseURL+'dashboard_doctor/appointment/appointment/doctor_by_department/',
            type : 'post',
            dataType : 'JSON',
            data : {
                'csrf_stream_token' : CSRF_TOKEN,
    ...
    $("#doctor_id").on('change', function(){
        ...
        $.ajax({
            url  : _baseURL+'dashboard_doctor/appointment/appointment/schedule_day_by_doctor/',
            type : 'post',
            dataType : 'JSON',
            data : {
                'csrf_stream_token' : CSRF_TOKEN,
    ...
    $("#date").on('change', function(){
        ...
        $.ajax({
            url  : _baseURL+'dashboard_doctor/appointment/appointment/serial_by_date/',
            type : 'post',
            dataType : 'JSON',
            data : {
                'csrf_stream_token' : CSRF_TOKEN,
